...
uses sysutils,main_engine,rom_engine,rom_export,
  ...
  spaceinvaders_hw,centipede_hw,karnov_hw,aliens_hw,thunderx_hw;
...
const
  ...
  (name:'Moon Cresta';year:'1980';snd:0;hi:false;zip:'mooncrst';grid:49;company:'Nichibutsu';rom:@mooncrst;samples:@galaxian_samples),
