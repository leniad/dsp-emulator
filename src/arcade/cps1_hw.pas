...
{CPS_B_21_QS3}  (layerctrl:$152;palctrl:$14c;testaddr:$14e;testval:$0c00;mula:$1ff;mulb:$1ff;mull:$1ff;mulh:$1ff;mask_sc1:$04;mask_sc2:$02;mask_sc3:$20;mask_sc4:$0;pri_mask1:$154;pri_mask2:$156;pri_mask3:$148;pri_mask4:$14a));
        ...
        //Ghouls and ghosts
        ghouls_rom1:array[0..4] of tipo_roms=(
        ...
        ghouls_gfx1:array[0..4] of tipo_roms=(
        ...
        //Final Fight
        ffight_rom1:array[0..4] of tipo_roms=(
        ...
        ffight_gfx1:array[0..4] of tipo_roms=(
        ...
        //King of Dragons
        kod_rom1:array[0..8] of tipo_roms=(
        ...
        kod_gfx1:array[0..8] of tipo_roms=(
        ...
        //Street Fighter 2
        sf2_rom1:array[0..8] of tipo_roms=(
        ...
        sf2_gfx1:array[0..12] of tipo_roms=(
        ...
        //Strider
        strider_rom1:array[0..4] of tipo_roms=(
        ...
        strider_gfx1:array[0..8] of tipo_roms=(
        ...
        //3 Wonder
        wonder3_rom1:array[0..8] of tipo_roms=(
        ...
        wonder3_gfx1:array[0..8] of tipo_roms=(
        ...
        ccommando_gfx1:array[0..8] of tipo_roms=(
        ...
        knights_rom1:array[0..2] of tipo_roms=(
        ...
        knights_gfx1:array[0..8] of tipo_roms=(
        ...
        dino_rom1:array[0..3] of tipo_roms=(
        ...
        dino_gfx1:array[0..8] of tipo_roms=(
        ...
        //The Punisher
        punisher_rom1:array[0..8] of tipo_roms=(
        ...
        punisher_gfx1:array[0..8] of tipo_roms=(
...
procedure convert_chars(memoria_temp:pbyte;n:dword);
begin
  init_gfx(0,8,8,n);
  init_gfx(1,8,8,n);
  gfx[0].trans[15]:=true;
...
case main_vars.tipo_maquina of
  103:begin
        ...
        //Tiles 16x16
        convert_tiles16(memoria_temp,$6000);
        //Tiles 32x32
        convert_tiles32(memoria_temp,$1800);
        dswa:=$FF;
        dswb:=$FF;
        dswc:=$FF;
  end;
  104:begin
        ...
        //Tiles 16x16
        convert_tiles16(memoria_temp,$4000);
        //Tiles 32x32
        convert_tiles32(memoria_temp,$1000);
        dswa:=$FF;
        dswb:=$F4;
        dswc:=$9F;
  end;
  105:begin
        ...
        //Tiles 16x16
        convert_tiles16(memoria_temp,$8000);
        //Tiles 32x32
        convert_tiles32(memoria_temp,$2000);
        dswa:=$FF;
        dswb:=$FC;
        dswc:=$9F;
  end;
  106:begin
        ...
        //Tiles 16x16
        convert_tiles16(memoria_temp,$c000);
        //Tiles 32x32
        convert_tiles32(memoria_temp,$3000);
        dswa:=$FF;
        dswb:=$FC;
        dswc:=$9F;
  end;
...
res:=$FFFF;
case dir of
  $000,$002,$004,$006:res:=(marcade.in2 shl 8)+marcade.in1; //P1
  $018:res:=(marcade.in0 shl 8)+$ff; //marcade.in0
...
case direccion of
  ...
  $f001:cps1_snd_getbyte:=YM2151_status_port_read(0);
...
case direccion of
  ...
  $f000:YM2151_register_port_write(0,valor);
  $f001:YM2151_data_port_write(0,valor);
