...
case main_vars.tipo_maquina of
  ...
  37,151,152,154:close_ppi8255(0);
end;
close_audio;
close_video;
end;
...
case (puerto and $1f) of
  ...
  $14..$17:system1_inbyte_ppi:=ppi8255_r(0,puerto and $3);
end;
end;
...
begin
case (puerto and $1f) of
  $14..$17:ppi8255_w(0,puerto and $3,valor);
end;
end;
...
case direccion of
  ...
  $e000..$ffff:begin
                  ...
                  port_c_val:=ppi8255_get_port(0,2);
                  ppi8255_set_port(0,2,port_c_val and $bf);
                  ppi8255_set_port(0,2,port_c_val or $40);
               end;
end;
end;
