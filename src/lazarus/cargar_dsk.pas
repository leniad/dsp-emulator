...
procedure TForm6.DirectoryEdit1Change(Sender: TObject);
begin
form6.FileListBox1.Directory:=form6.DirectoryEdit1.Directory;
end;
...
procedure TForm6.FileListBox1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
case key of
