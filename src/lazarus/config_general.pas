...
begin
  case num of
    ...
    libSDL_SCANCODE_RALT: nombre_tecla := 'R ALT';
    libSDL_SCANCODE_LALT:nombre_tecla:='L ALT';
    libSDL_SCANCODE_RSHIFT: nombre_tecla := 'R SHIFT';
    libSDL_SCANCODE_LSHIFT: nombre_tecla := 'L SHIFT';
    libSDL_SCANCODE_RCTRL: nombre_tecla := 'R CTRL';
    libSDL_SCANCODE_LCTRL: nombre_tecla := 'L CTRL';
